                    ...
                    <div className="form-wrap col-lg-12">
                        <div className="form-horizontal">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-10">
                                    <select type="password" className="form-control cate-select col-md-5"
                                            value={this.state.firstCategoryId} onChange={this.onFirstCategoryChange}>
                                            ...
                                            return (
                                                <div className="sub-img" key={index}>
                                                    ...
                                                    <i className="fa fa-close fa-fw"
                                                       onClick={this.onDeleteImage.bind(this, image)}></i>
                                                </div>
                                            );
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-10">
                                    <RichEditor ref="rich-editor" onValueChange={this.onRichValueChange}
                                                placeholder="商品详细信息"/>
                                </div>
                            </div>
                            <div className="form-group">
